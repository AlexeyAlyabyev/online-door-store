...
class ControllerCatalogAttribute extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->get['attribute_id'])) {
			...
			foreach ($data['list_values'] as $key => $value){
				if (isset($data['list_values'][$key]['image']))
					$data['list_values'][$key]['thumb'] = "../image/" . $data['list_values'][$key]['image'];
				else
					$data['list_values'][$key]['thumb'] = $this->model_tool_image->resize('no_image.png', 100, 100);
			}
		}
		else {
