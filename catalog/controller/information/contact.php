...
class ControllerInformationContact extends Controller {
	...
	public function index() {
		...
		// Last-Modified
		$template_name = "information/contact";
		...
		$this->document->setTitle('Контактная информация компании «100 Дверей» в Москве');
		$this->document->setDescription('Контактная информация компании «100 Дверей» в Москве и области. ✅ Бесплатный замер ✅ Качественная установка под ключ ✅ Всегда скидки и акции ✅ Средняя оценка 4,87 ☎ +7 (495) 021-55-32');
