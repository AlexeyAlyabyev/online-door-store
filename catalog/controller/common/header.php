...
class ControllerCommonHeader extends Controller {
	public function index() {
		...
		$data["current_url"] = "https://" . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'];

		$data['title'] = $this->document->getTitle();
		$data['seoText'] = $this->config->get('seoText');
		...
		$data['city'] = $this->model_localisation_zone->getZone($data['zone_id']);
    ...
    foreach ($mobile_agent_array as $value) {    
		...
		// if ($data["language"] != "ru-ru" || count($_GET)-1)
		// 	$data['canonical_url'] = $_SERVER['REQUEST_SCHEME'] . '://100-dverei.ru' . $_SERVER['REQUEST_URI'];
