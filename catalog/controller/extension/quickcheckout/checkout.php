...
class ControllerExtensionQuickCheckoutCheckout extends Controller {
	...
	public function index() {
		...
		$data['shipping_method'] = $this->load->controller('extension/quickcheckout/shipping_method');   // custom
		$data['cart'] = $this->load->controller('extension/quickcheckout/cart');
		$data['header'] = $this->load->controller('common/header');

		$this->response->setOutput($this->load->view('extension/quickcheckout/checkout_test', $data));
  	}
